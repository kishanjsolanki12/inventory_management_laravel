            ...
            <div class="d-flex align-items-center">
                    ...
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                ...
                                {{-- <li class="breadcrumb-item" aria-current="page">{{ __('messages.vendor_management') }}</li> --}}
                ...
                <div class="container">
                    <div class="box-header">
                        <a href="{{route('vendor_management.index')}}"  class="btn btn-secondary fa fa-arrow-left btn-sm float-right">Back</a>
                    </div>
                </div>
            </div>
        </div>
        <!-- Main content -->
        <form method="POST" action="{{ route('vendor_management.store') }}" class="form" novalidate data-parsley-validate="" enctype="multipart/form-data">
                ...
                <div class="col-12">
                    <div class="box">
                        <div class="box-body">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-block">
                                            <input type="text" name="first_name" id="first_name" class="form-control focus:shadow-outline @error('first_name') is-invalid @enderror" value="{{ !empty($user->first_name)?$user->first_name:''}}" autocomplete="off" required/>
                                            @error('first_name')
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-block">
                                            <input type="text" name="last_name" id="last_name" class="form-control focus:shadow-outline @error('last_name') is-invalid @enderror" value="{{ !empty($user->last_name)?$user->last_name:''}}" autocomplete="off" required/>
                                            @error('last_name')
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-block">
                                            <input type="text" name="email" id="email" autocomplete='new-email' class="form-control focus:shadow-outline @error('email') is-invalid @enderror" value="{{ !empty($user->email)?$user->email:''}}" autocomplete="off" required/>
                                            @error('email')
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-block">
                                            <textarea name="address" id="address" class="form-control focus:shadow-outline @error('address') is-invalid @enderror" value="{{ old('address') }}" maxlength="255" autocomplete="off">{{ !empty($user->address)?$user->address:''}}</textarea>
                                            @error('address')
                                ...
                                <div class="col-md-4">
                                   <div class="form-group">
                                       ...
                                       <div class="input-block">
                                            <input type="file"  multiple class="form-control" id="image_name"  name="image_name"   accept=".jpg,.png,.jpeg" data-default-file="" value="">
                                           @error('image')
                                               <p class="help invalid-feedback">{{ $errors->first('image') }}</p>
                                           @enderror
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-block">
                                            <input type="password" name="password" id="password" autocomplete='new-password' class="form-control focus:shadow-outline @error('password') is-invalid @enderror" autocomplete="off" required="" />
                                            @error('password')
                        ...
                        <div class="box-footer">
                            ...
                            <a href="{{route('vendor_management.index')}}"  class="btn btn-secondary">Cancel</a>
                        </div>
...
<script type="text/javascript">
     $(document).on("change",".country",function(){
        ...
        var url = "/admin/vendor_management/get_state";
    ...
    $(document).on("change",".state",function(){
        ...
        var url = "/admin/vendor_management/get_city";
    ...
    $(document).on("change",".city",function(){
        ...
        var url = "/admin/vendor_management/get_area";
