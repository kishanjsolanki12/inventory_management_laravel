...
@section('content')
  ...
  <div class="content-wrapper">
      <div class="container-full">
                ...
                <div class="me-auto">
                    <h4 class="page-title">
                        <?php
                         ...
                         { ?>
                        {{ __('messages.vendor_management') }}
                         <?php }else{ ?>
                        {{ __('messages.vendor_profile') }}
                       <?php }?>
                        </h4>
        ...
        <!-- Main content -->
         <form method="POST" id="user-form" action="{{ route('vendor_management.update', $user) }}" class="form" novalidate data-parsley-validate="" enctype="multipart/form-data">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-block">
                                            <input type="text" name="first_name" id="first_name" class="form-control focus:shadow-outline @error('first_name') is-invalid @enderror" value="{{ old('first_name', $user->first_name) }}" autocomplete="off" required/>
                                            @error('first_name')
                                       ...
                                       <div class="input-block">
                                           ...
                                           <?php if(!empty($user->image)) { ?>
                                             <div class="col-md-3">
                                                ...
                                                <img data-dz-thumbnail="" alt="productlisting.png" src="{{ asset('/images/'.$user->image) }}" style="height: 120px;">
