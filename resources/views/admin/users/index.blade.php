        ...
        <div class="box">
          <div class="box-header">  
              ...
              <div class="row">
                    ...
                    <div class="col-md-2">
                     <a href="/admin/users/create" class="btn btn-primary float-right">Add New User</a>
                    </div>
              </div>
          </div>
          <div class="box-body">
            <div class="table-responsive">
              <table id="complex_header" class="table table-striped table-bordered display" style="width:100%">
               <thead>
                    ...
                    <tbody>
                        @include('admin.users.user_pagination_data')
                    </tbody>
              </table>
...
$(document).ready(function(){
 ...
 {
  $.ajax({
   url:"/admin/users/fetch_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&query="+query+"&per_page="+per_page+"&role="+role,
