      ...
      <div class="container-full">
        ...
        <div class="content-header">
            <div class="d-flex align-items-center">
                <div class="me-auto">
                    <h4 class="page-title">{{ __('messages.club_user') }}</h4>
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                                {{-- <li class="breadcrumb-item" aria-current="page">{{ __('messages.club_user') }}</li> --}}
                                <li class="breadcrumb-item active" aria-current="page">Edit Club User </li>
                            </ol>
                        </nav>
                    </div>
                </div>
                <div class="container">
                    <div class="box-header">                        
                        <a href="{{route('club_user.index')}}"  class="btn btn-secondary fa fa-arrow-left btn-sm float-right">Back</a>
                    </div>
                </div>
            </div>
        </div>
        <!-- Main content -->
         ...
         <form method="POST" id="user-form" action="{{ route('club_user.update', $user->id) }}" class="form" novalidate data-parsley-validate="">
                ...
                <div class="col-12">
                    <div class="box">
                        ...
                        <div class="box-footer">
                            ...
                            <a href="{{route('club_user.index')}}"  class="btn btn-secondary">Cancel</a>
                        </div>  
