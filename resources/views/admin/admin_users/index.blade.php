          ...
          <div class="box-header">  
              ...
              <div class="row">
                   ...
                   <!--  <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                     <a href="/admin/admin_user/create" class="btn btn-primary float-right">Add New Admin</a>
                    </div>
              </div>
          </div>
          <div class="box-body">
              ...
              <table id="complex_header" class="table table-striped table-bordered display" style="width:100%">
               <thead>
                        <tr class="text-left border-b-2 border-gray-300">
                            <th class="px-4 py-3 sorting" data-sorting_type="asc" data-column_name="name" style="cursor: pointer">First Name</th>
                    ...
                    <tbody>
                        @include('admin.admin_users.user_pagination_data')
                    </tbody>
              </table>
...
$(document).ready(function(){
 ...
 {
  $.ajax({
   url:"/admin/admin_user/fetch_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&query="+query+"&per_page="+per_page+"&role="+role,
