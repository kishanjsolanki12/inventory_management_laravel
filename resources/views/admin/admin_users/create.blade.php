...
@section('content')
  ...
  <div class="content-wrapper">
      <div class="container-full">
        ...
        <!-- Main content -->
        <form method="POST" action="{{ route('admin_user.store') }}"  class="form" novalidate data-parsley-validate="">
                        ...
                        <div class="box-body">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-block">
                                            <input type="text" name="email" id="email"  class="form-control focus:shadow-outline @error('email') is-invalid @enderror" value="{{ !empty($user->email)?$user->email:''}}" autocomplete='new-email' required/>
                                            @error('email')
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-block">
                                            <input type="password" name="password" id="password" class="form-control focus:shadow-outline @error('password') is-invalid @enderror" autocomplete='new-password' required="" />
                                            @error('password')
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-block">
                                            <input type="password" name="password_confirmation" id="password_confirmation" data-parsley-equalto="#password" class="form-control focus:shadow-outline" autocomplete='new-password'  required="" />
