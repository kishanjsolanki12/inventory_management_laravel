    ...
    <div class="content-header">
      ...
      <div class="d-flex align-items-center">
        ...
        <div class="me-auto">
          ...
          <h4 class="page-title">{{ __('messages.report') }}</h4>
               ...
               <thead>
                        <tr class="text-left border-b-2 border-gray-300">
                           <th class="px-4 py-3 sorting" data-sorting_type="asc" data-column_name="category_name" style="cursor: pointer">Product Name</th>
                            <th class="px-4 py-3">Purchase Quantity</th>
                            <th class="px-4 py-3">Unit Price</th>
                            <th class="px-4 py-3">Total Purchase Price</th>
                            <th class="px-4 py-3">Selling Quantity </th>
                            <th class="px-4 py-3">Unit Price </th>
                            <th class="px-4 py-3">Total Selling Price </th>
                            <th class="px-4 py-3">Unsold Quantity</th>
                            <th class="px-4 py-3">Unsold Product Price </th>
                    ...
                    @include('admin.report.user_pagination_data')
...
$(document).ready(function(){
...

 {
  ...
  $.ajax({
   ...
   url:"/admin/report/fetch_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&query="+query+"&per_page="+per_page,
