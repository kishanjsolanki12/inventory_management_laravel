    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="px-6 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('email_templates.update', $email_template) }}" class="form" novalidate data-parsley-validate="">
                    ...
                    <div class="form-row">
                        ...
                        <div class="input-block">
                            ...
                            <select class="text-input appearance-none focus:shadow-outline" name="template_status" id="template_status">
                                ...
                                <option <?=($email_template->template_status == '0')?'selected="selected"':''?> value="0">Deactive</option>
                            </select>
                           @error('status')
