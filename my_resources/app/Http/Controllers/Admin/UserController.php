...

{
    ...
    function fetch_data(Request $request)
    {
        if($request->ajax())
        {
            ...
            $users =     User::
                        ...
                        ->whereRaw($role_query.'(users.name like "%'.$query.'%" or users.email like "%'.$query.'%")')
...

    {
       ...
       $validatedAttributes = request()->validate([
        ...
        {
          $validatedAttributes['territory_id'] = !empty($postData['territory_id'])?implode(',',$postData['territory_id']):'';
        }
...

    {
        ...
        return view('admin.users.edit', ['user' => $user, 'roles' => $roles,'countries'=>$countries,'state'=>$state,'city'=>$city,'area'=>$area]);
