...
use DB;
class CtReportExport implements FromView,WithColumnFormatting
{
    protected $id;
    ...
    {
            $ct_visit =  DailyTherapistVisitTransection::selectRaw('daily_therapist_visit_transection.*,tt.treatment_type_title,mt.type_name,pt.visit_type,pt.starting_date,pt.visit_time,group_concat(distinct mt.type_name) as thearpy_list,group_concat(distinct daily_therapist_visit_transection.therapy_id) as thearpy_ids,concat(p.first_name," ",p.last_name) as patient_name,mv.visit_type_title')
        ...
        return view('admin.reports.ct_report.export', [
            'ct_visit' => $ct_visit,
            'month' => $this->month,
            'year' => $this->year,
